...
**При подтверждении**: бот передаёт обращение в Assyst, заявка сохраняется в БД:
...
### 5.5. Диаграмма последовательности: Главное меню
...
### 5.6. Диаграмма последовательности: Создание заявки
...
2. Определить пользователя по `email` → найти связанный `chat_id`.
